...
professor_urls = [
    "https://scholar.google.com/citations?user=HMAzliEAAAAJ",  # Dr. Sanyam Shukla (MANIT Bhopal)
    "https://scholar.google.com/citations?user=0YYnNYkAAAAJ",  # Jay Kumar Jain (MANIT Bhopal)
    "https://scholar.google.com/citations?user=fWgOgcIAAAAJ",  # Dr. Mitul Kumar Ahirwal (MANIT Bhopal)
    "https://scholar.google.com/citations?user=97HSz70AAAAJ",  # Vaibhav Soni (MANIT Bhopal)
    "https://scholar.google.com/citations?user=cPorLCwAAAAJ"   # Vijay Bhaskar Semwal (MANIT Bhopal)
]
...
# Save to CSV
df.to_csv("nitb_professor_citation_data.csv", index=True)
print("Data saved to nitb_professor_citation_data.csv")